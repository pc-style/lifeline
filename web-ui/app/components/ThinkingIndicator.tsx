...
export function ThinkingIndicator() {
  return (
    <div className="flex justify-start mb-4 px-4">
      <div className="max-w-[85%] sm:max-w-[75%] rounded-2xl px-4 py-3 bg-gray-100 dark:bg-gray-800">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-gray-600 dark:text-gray-300">LifeLine is thinking...</span>
        </div>
      </div>
    </div>
  );
